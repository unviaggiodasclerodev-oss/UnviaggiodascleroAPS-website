    ...
    <div class="section-pad">
      <div class="grid md:grid-cols-2 gap-16 items-start">
        ...
        <div class="reveal">
          ...
          <div class="space-y-4">
            <a href="mailto:info@unviaggiodascleroaps.org"
              class="flex items-center gap-4 card-solid p-5 group">
              <div class="w-12 h-12 rounded-xl bg-accent/10 flex items-center justify-center shrink-0 group-hover:bg-accent group-hover:scale-110 transition-all duration-300">
              ...
              <div>
                <p class="tx font-semibold text-sm">Email</p>
                <p class="text-accent text-sm group-hover:underline">info@unviaggiodascleroaps.org</p>
              </div>
            </a>
            <a href="https://wa.me/393516200034" target="_blank" rel="noopener"
              class="flex items-center gap-4 card-solid p-5 group">
              <div class="w-12 h-12 rounded-xl bg-accent/10 flex items-center justify-center shrink-0 group-hover:bg-accent group-hover:scale-110 transition-all duration-300">
                <svg class="w-5 h-5 text-accent group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <p class="tx font-semibold text-sm">WhatsApp</p>
                <p class="text-accent text-sm group-hover:underline">+39 351 620 0034</p>
              </div>
            </a>
          </div>
        </div>
        ...
        <div class="reveal" style="transition-delay:0.15s">
          <p class="tx font-semibold text-sm mb-5">Seguici sui social</p>
          <div class="space-y-3">
            <a href="https://www.instagram.com/unviaggiodascleroaps/" target="_blank" rel="noopener"
              class="flex items-center gap-4 card-solid p-5 group">
              <div class="w-11 h-11 rounded-xl bg-accent/10 text-accent flex items-center justify-center shrink-0 group-hover:bg-accent group-hover:text-white transition-colors">
              ...
              <div>
                <p class="tx font-semibold text-sm">Instagram</p>
                <p class="tx2 text-xs">APS Un Viaggio da Sclero</p>
              </div>
            </a>
            <a href="https://www.facebook.com/profile.php?id=61587496840130" target="_blank" rel="noopener"
              ...
              <div>
                <p class="tx font-semibold text-sm">Facebook</p>
                <p class="tx2 text-xs">APS Un Viaggio da Sclero</p>
              </div>
            </a>
            <a href="https://www.linkedin.com/in/un-viaggio-da-sclero-aps-8875bb3ab/" target="_blank" rel="noopener"
              ...
              <div>
                <p class="tx font-semibold text-sm">LinkedIn</p>
                <p class="tx2 text-xs">APS Un Viaggio da Sclero</p>
              </div>
            </a>
          </div>
