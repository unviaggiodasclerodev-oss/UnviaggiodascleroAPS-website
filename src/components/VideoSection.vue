...
<template>
  ...
  <section class="relative overflow-hidden min-h-[55vh] md:min-h-[70vh] flex flex-col justify-end" style="background:#0A0A0A">
    <video
      ref="videoRef"
    ...
    <!-- Content bottom-left -->
    <div class="relative z-10 section-pad pb-14 pt-32">
