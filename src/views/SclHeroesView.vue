        ...
        <section class="section-pad">
          <div class="max-w-3xl mx-auto">
            <div class="rounded-2xl p-8 md:p-10 text-center border border-stone-200/50 dark:border-white/10 bg-stone-50 dark:bg-stone-800 shadow-sm reveal">
              ...
              <h2 class="text-2xl md:text-3xl font-bold tx mb-3">Ascolta il podcast sclHEROES</h2>
              <p class="tx2 leading-relaxed max-w-xl mx-auto mb-8">
                Le storie raccontate in diretta diventano episodi da riascoltare quando vuoi, su Spotify.
              </p>
              <a href="https://open.spotify.com/show/033Tj4IHgjsy4fDFNdRkIZ" target="_blank" rel="noopener noreferrer"
                class="group inline-flex items-center gap-2 text-white font-semibold px-8 py-4 rounded-full transition-all text-sm tracking-wide shadow-md hover:brightness-95"
